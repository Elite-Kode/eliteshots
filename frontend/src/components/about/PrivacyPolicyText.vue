...
<template>
  <div>
    <p>
      ...
      a single person, or to identify an individual in context. Please read my privacy policy carefully to get a
      clear understanding of how I collect, use, protect or otherwise handle your Personally Identifiable Information
    ...
    <p>
      I collect minimal information from you when you register on my site.
    </p>
    <p>
    ...
    <ul>
      <li>
        To personalize your experience and to allow me to deliver the type of content in which you are most
        interested.
      </li>
      <li>
        To follow up with them after correspondence (live chat or email enquiries)
      </li>
    </ul>
    <p>
    ...
    <p>
      I only provide articles and information. I never ask for credit card numbers. I do not use Malware Scanning.
    </p>
    <p>
      Your personal information is contained behind secured networks and is only accessible by me and I am required
      to keep the information confidential. In addition, all sensitive information you supply is encrypted via Secure
      Socket Layer (SSL) technology.
    </p>
    <p>
      I implement a variety of security measures when a user enters, submits, or accesses their information to
    ...
    <p>
      I use cookies to keep logged in sessions alive between page navigation and understand and save user's
      preferences for future visits.
    </p>
    <p>
      You consent to the use of cookies by using this website. If you don't want to use cookies, you can choose to
    ...
    <p>
      ...
      third-party sites have separate and independent privacy policies. I therefore have no responsibility or
      liability for the content and activities of these linked sites. Nonetheless, I seek to protect the integrity of
      my site and welcome any feedback about these sites.
    </p>
    <p>
    ...
    <p>
      According to CalOPPA, I agree to the following: Users can visit my site anonymously. Once this privacy policy
      is created, I will add a link to it on my home page or as a minimum, on the first significant page after
      entering my website. My Privacy Policy link includes the word 'Privacy' and can easily be found on the page
      specified above.
    </p>
    <p>
