      ...
      <template v-slot:thumbnail="slotProps">
        <v-card>
          ...
          <v-card-actions>
            <v-row dense>
              <v-col cols="6">
                <v-btn :disabled="!canMod(slotProps.imageItem.user_id)" block color="success"
              ...
              <v-col cols="6">
                <v-btn :disabled="!canMod(slotProps.imageItem.user_id)" block color="error" outlined
