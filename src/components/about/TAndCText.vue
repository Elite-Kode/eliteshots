...
<template>
  <div>
    <p>
      ...
      bound by the following terms and conditions of use, which together with our privacy policy govern Elite BGS's
      relationship with you in relation to this website. If you disagree with any part of these terms and conditions,
      please do not use our website.
    </p>
    <p>
      The term 'Elite BGS' or 'me' or 'I' refers to the owner of the website. The term 'you' refers to the user or
